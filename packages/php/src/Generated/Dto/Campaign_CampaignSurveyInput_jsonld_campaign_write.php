...
final class Campaign_CampaignSurveyInput_jsonld_campaign_write
{
    public function __construct(
        public readonly string $audience,
        public readonly ?CampaignConfig_jsonld_campaign_write $campaign_config,
        public readonly ?EmailConfig_jsonld_campaign_write $email_config,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            campaign_config: isset($data['campaign_config']) ? CampaignConfig_jsonld_campaign_write::fromArray($data['campaign_config']) : null,
            email_config: isset($data['email_config']) ? EmailConfig_jsonld_campaign_write::fromArray($data['email_config']) : null,
