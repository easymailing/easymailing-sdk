...
final class Campaign_campaign_read_campaign_read_detail
{
    public function __construct(
        public readonly ?string $audience = null,
        public readonly ?CampaignConfig_campaign_read_campaign_read_detail $campaign_config = null,
        public readonly ?CampaignConfigSend_campaign_read_campaign_read_detail $campaign_config_send = null,
        public readonly ?CampaignStat_campaign_read_campaign_read_detail $campaign_stats = null,
        ...
        public readonly ?CampaignTestConfigResource_campaign_read_campaign_read_detail $test_config = null,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            campaign_config: isset($data['campaign_config']) ? CampaignConfig_campaign_read_campaign_read_detail::fromArray($data['campaign_config']) : null,
            campaign_config_send: isset($data['campaign_config_send']) ? CampaignConfigSend_campaign_read_campaign_read_detail::fromArray($data['campaign_config_send']) : null,
            campaign_stats: isset($data['campaign_stats']) ? CampaignStat_campaign_read_campaign_read_detail::fromArray($data['campaign_stats']) : null,
            channel: $data['channel'] ?? null,
            created_at: isset($data['created_at']) ? new \DateTimeImmutable($data['created_at']) : null,
            email_config: isset($data['email_config']) ? EmailConfig_campaign_read_campaign_read_detail::fromArray($data['email_config']) : null,
            ...
            test_config: isset($data['test_config']) ? CampaignTestConfigResource_campaign_read_campaign_read_detail::fromArray($data['test_config']) : null,
            title: $data['title'] ?? null,
            type: isset($data['type']) ? \Easymailing\Sdk\Generated\Enum\CampaignType::from($data['type']) : null,
            updated_at: isset($data['updated_at']) ? new \DateTimeImmutable($data['updated_at']) : null,
            uuid: $data['uuid'] ?? null,
            variants: isset($data['variants']) ? array_map(fn($x) => CampaignTestVariantResource_campaign_read_campaign_read_detail::fromArray($x), $data['variants']) : null,
