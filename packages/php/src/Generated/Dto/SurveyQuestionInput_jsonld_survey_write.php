...
final class SurveyQuestionInput_jsonld_survey_write
{
    public function __construct(
        public readonly string $text,
        public readonly string $type,
        public readonly ?string $display = null,
        /** @var list<SurveyOptionInput_jsonld_survey_write>|null */
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            options: isset($data['options']) ? array_map(fn($x) => SurveyOptionInput_jsonld_survey_write::fromArray($x), $data['options']) : null,
