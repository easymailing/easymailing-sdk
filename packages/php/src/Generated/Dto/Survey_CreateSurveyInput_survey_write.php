...
final class Survey_CreateSurveyInput_survey_write
{
    public function __construct(
        public readonly string $name,
        public readonly string $type,
        public readonly ?string $locale = null,
        /** @var list<SurveyQuestionInput_survey_write>|null */
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            questions: isset($data['questions']) ? array_map(fn($x) => SurveyQuestionInput_survey_write::fromArray($x), $data['questions']) : null,
        );
    }
